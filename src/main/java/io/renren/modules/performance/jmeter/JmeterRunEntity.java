...
public class JmeterRunEntity {
     ...
     */
    private Integer runStatus = PerformanceTestUtils.INITIAL;
    ...
    public PerformanceCaseFileEntity getperTestFile() {
        return perTestFile;
    }

    public void setperTestFile(PerformanceCaseFileEntity perTestFile) {
        this.perTestFile = perTestFile;
    }

    public PerformanceCaseReportsEntity getStressTestReports() {
        return perTestReports;
    }

    public void setStressTestReports(PerformanceCaseReportsEntity stressTestReports) {
        this.perTestReports = stressTestReports;
    }
