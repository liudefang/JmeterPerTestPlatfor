package io.renren.modules.performance.jmeter.engine;

import io.renren.modules.performance.entity.PerformanceCaseFileEntity;
import io.renren.modules.performance.jmeter.JmeterTestPlan;
...
public class LocalStandardJMeterEngine extends StandardJMeterEngine {
    ...
    public LocalStandardJMeterEngine(PerformanceCaseFileEntity perTestFile) {
        this("");
